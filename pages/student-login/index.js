    ...
    return <>
        ...
        <Container centerContent maxW={"6xl"} mt={10}>
            <Flex>
                ...
                <Box background={"#E8D2A6"} p={4} onClick={() => router.push("/student-login/animation")} border="1px" borderColor={"#e6e6e6"} borderRadius={5} margin={2}>Animation Videos</Box>
                <Box background={"#F48484"} p={4} border="1px" borderColor={"#e6e6e6"} borderRadius={5} margin={2}>Lesson-Wise Assessments</Box>
                <Box background={"#F55050"} p={4} border="1px" borderColor={"#e6e6e6"} borderRadius={5} margin={2}>Main Examination</Box>
            </Flex>
        </Container>
    </>
}
